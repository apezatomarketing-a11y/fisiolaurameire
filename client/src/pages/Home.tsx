...
import { MapPin, MessageCircle, Star, Users, Award, CheckCircle2, Zap, Heart } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background selection:bg-primary/30">
            ...
            <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0 animate-in fade-in slide-in-from-left-10 duration-1000 delay-300">
                  Sessões presenciais, acompanhamento domiciliar, visitas domiciliares e confecção de órtese de impressão 3D personalizada.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
                <button
                  ...
                  className="group relative px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold text-lg overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-xl shadow-blue-600/20"
                >
        ...
        <div className="container px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative group order-1 lg:order-2">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-400 rounded-[3rem] opacity-20 blur-2xl" />
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-8 border-card shadow-2xl bg-muted">
                <img
        ...
        <div className="container px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-20">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-6xl font-black mb-4 tracking-tighter">Serviços</h2>
          ...
          <div className="space-y-16">
            {SERVICES.map((service, index) => (
              <div key={service.id} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${index % 2 === 1 ? 'lg:auto-cols-fr' : ''}`}>
                {/* Image - alternates position */}
                <div className={`relative group ${index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'}`}>
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-400 rounded-[3rem] opacity-20 blur-2xl" />
                  <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden border-8 border-card shadow-2xl bg-muted">
                    <img
                      src={service.id === 'pilates-1x' || service.id === 'pilates-2x' || service.id === 'pilates-3x' 
                        ? FEATURED_IMAGES.pilates 
                        : service.id === 'reabilitacao-neuro' 
                        ? FEATURED_IMAGES.reabilitacao 
                        : service.id === 'pediatria' 
                        ? FEATURED_IMAGES.pediatria 
                        : FEATURED_IMAGES.ortese}
                      alt={service.title}
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    />
                  </div>
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                  <div>
                    <h3 className="text-3xl md:text-4xl font-black mb-4 tracking-tighter">{service.title}</h3>
                  ...
                  <button
                    ...
                    className="group relative px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold text-lg overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-xl shadow-blue-600/20 w-full sm:w-auto"
                  >
                    <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                    <span className="relative flex items-center gap-2 justify-center">
        ...
        <div className="container relative z-10 px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              { label: 'Satisfação', val: '98%', icon: Star, color: 'text-blue-600' },
              { label: 'Especialidades', val: '5+', icon: CheckCircle2, color: 'text-blue-500' },
            ].map((stat, i) => (
              <div key={i} className="group p-8 md:p-10 bg-card border border-border rounded-[2.5rem] hover-lift text-center shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <div className="container px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-10">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter">Agende sua Avaliação</h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  <div className="p-5 bg-blue-600/10 rounded-2xl h-fit">
                    <MapPin className="text-blue-600" size={32} />
                  </div>
                  <div>
                    <p className="font-bold text-2xl mb-2">Localização</p>
                ...
                <button
                  onClick={() => handleWhatsApp(WHATSAPP_MESSAGES.floatingButton)}
                  className="w-full md:w-auto px-10 py-5 bg-blue-600 text-white rounded-2xl font-bold text-lg hover:scale-105 transition-all shadow-xl shadow-blue-600/20"
                >
                  Falar no WhatsApp
                </button>
              </div>
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-400 rounded-[3rem] opacity-20 blur-2xl" />
              <div className="relative h-[500px] rounded-[3rem] overflow-hidden border-8 border-card shadow-2xl">
                <iframe
      ...
      <section className="py-24 md:py-32 container px-6 md:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="relative p-16 md:p-32 bg-gradient-to-r from-blue-600 to-blue-500 rounded-[5rem] overflow-hidden text-center text-white shadow-2xl">
          ...
          <div className="relative z-10 space-y-10 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-blue-50/80 font-medium">Agende sua avaliação e dê o primeiro passo para uma vida com mais movimento, menos dor e melhor qualidade de vida.</p>
            <button
              onClick={() => handleWhatsApp(WHATSAPP_MESSAGES.floatingButton)}
              className="px-16 py-8 bg-white text-blue-600 rounded-3xl font-black text-2xl hover:scale-110 transition-all shadow-2xl active:scale-95"
            >
              Agendar via WhatsApp
            </button>
          </div>
